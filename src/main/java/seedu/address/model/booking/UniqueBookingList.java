 ...
 * A booking is considered unique by comparing using {@code Booking#isSameBooking(Booking)}.
 * As such, adding and updating of bookings uses Booking#isSameBooking(Booking) for equality
