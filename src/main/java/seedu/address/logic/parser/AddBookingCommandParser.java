    ...
    public AddBookingCommand parse(String args) throws ParseException {
        ArgumentMultimap argMultimap =
                ArgumentTokenizer.tokenize(args,
                        PREFIX_DESCRIPTION, PREFIX_DATETIME, PREFIX_PACKAGETYPE, PREFIX_TAG);

        if (!arePrefixesPresent(argMultimap, PREFIX_DESCRIPTION, PREFIX_DATETIME, PREFIX_PACKAGETYPE)) {
